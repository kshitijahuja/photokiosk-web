...
const IconUsers = () => (
  <svg className="w-8 h-8 text-primary mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 4.354a4 4 0 110 5.292M15 12H9m4 5a4 4 0 100-8 4 4 0 000 8z" />
  </svg>
);
...
const IconBox = () => (
  <svg className="w-8 h-8 text-primary mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M20 7l-8-4-8 4m16 0l-8 4m0 0L4 7m8 4v10l8-4v-10M4 7v10l8 4" />
  </svg>
);
...
const IconShield = () => (
  <svg className="w-8 h-8 text-primary mb-4" fill="none" stroke="currentColor" viewBox="0 0 24 24">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4m7.784-4.817a.5.5 0 00-.596.72c.123.195.20.462.2.738 0 .833-.464 1.547-1.155 1.943M12 3v2.5M5.5 7.5A3 3 0 015 10v4a7 7 0 0014 0v-4a3 3 0 00-.5-2.5" />
  </svg>
);
    ...
    <div className="w-full">
      ...
      <section className="py-20 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 divide-x divide-y divide-gray-200 border border-gray-200">
            <div className="p-8">
              <IconMobile />
      ...
      <section className="py-20 sm:py-24 bg-gray-50">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 divide-x divide-y divide-gray-200 border border-gray-200">
            ...
            <div className="p-8 bg-white">
              <IconSettings />
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Configurable Visibility</h3>
      ...
      <section className="py-20 sm:py-24 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-0 divide-x divide-y divide-gray-200 border border-gray-200">
            ...
            <div className="p-8">
              <IconCloud />
              <h3 className="text-2xl font-bold text-gray-900 mb-3">Google Drive Integration</h3>
            ...
            <div className="p-8">
              <IconShield />
              <h3 className="text-2xl font-bold text-gray-900 mb-3">CSRF Protection</h3>
      ...
      <section className="bg-primary text-white py-16">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <a href="/contact" className="px-10 py-4 bg-white text-primary font-bold rounded-lg hover:bg-gray-100 transition-colors text-lg inline-block">
            Request a Demo
          </a>
        </div>
      </section>
